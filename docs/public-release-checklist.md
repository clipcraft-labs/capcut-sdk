...
- [ ] Review `git diff --stat` and every new file.
...
- [ ] Review CapCut terms, applicable law, and redistribution constraints.
- [ ] Create the public GitHub repository only after the above checks pass.
